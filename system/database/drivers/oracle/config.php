...
function ft_settings_external_load() {
  ...
  $ft["settings"]["DIR"]               = "/home/ingresoc/public_html"; // Your default directory. Do NOT include a trailing slash!
  ...
  $ft["settings"]["FILETYPEWHITELIST"] = ".htaccess .php .css .htm .html .jpg .png .gif .bmp"; // Add file types here to *only* allow those types to be uploaded.
